...
struct _DNSEntry* busquedaA(struct _DNSTable *dnsTable,char *domini);
void Ok_Operation(int socket);
void Error_message(int socket, short Error, short CodeError);
void process_Hello(int sock);
...
void process_change_domain(int socket, char* buffer, struct _DNSTable *dnsTable);
