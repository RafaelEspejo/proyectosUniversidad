...
const char* noip="IP inexistent";
const char* nodomain="Domini inexistent";
const char* ok="Operacio ben feta";
const char* nook="No s'ha pogut realitzar satisfactoriament la operacio";
